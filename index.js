...
const DOMAIN = process.env.DOMAIN || 'asss.alwaysdata.net';       // 填写项目域名或已反代的域名，不带前缀，例如：abc-domain.com
...
const NAME = process.env.NAME || 'Always';                       // 节点名称
const PORT = process.env.PORT || 7861;                     // http和ws服务端口
